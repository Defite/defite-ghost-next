import { getPostBySlug, getPostsByField } from '../../lib/posts';
...
export async function getStaticPaths() {
    const paths = getPostsByField('href');
...
export async function getStaticProps({ params }: any) {
    const post = getPostBySlug(params.slug, ['title', 'date', 'description', 'content'])
